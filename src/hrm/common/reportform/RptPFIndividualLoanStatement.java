...
public class RptPFIndividualLoanStatement extends Window 
{
	...
	public RptPFIndividualLoanStatement(SessionBean sessionBean,String menuId) 
	{
		this.sessionBean=sessionBean;
		this.setCaption("INDIVIDUAL PF LOAN STATEMENT :: "+sessionBean.getCompany());
	...
	private void reportpreview()
	{
		...
		try
		{
			...
			String query = " select * from  funIndividualPFLoanStatementNew('"+cmbEmployeeName.getValue().toString()+"','"+fromDate+"','"+toDate+"','"+loanType+"','"+cmbUnit.getValue()+"') ";
			...
			if(queryValueCheck(query))
			{
				...
				Window win = new ReportViewer(hm,"report/account/hrmModule/rptIndividualPFLoanStatement.jasper",
