...
public class EmailLogIn extends Window 
{
	...
	public EmailLogIn(SessionBean sessionBean,String menuId)
	{
		this.sessionBean = sessionBean;
		cm = new CommonMethod(sessionBean);
		this.setCaption("EMAIL LOG IN :: "+sessionBean.getCompany());
		this.setWidth("400px");
	...
	public void loginBtnAction()
	{
		...
		{
			Window win = new sendPayslip(sessionBean,Email,password);
