...
public class RptDailyLateIn extends Window
{
	...
	public RptDailyLateIn(SessionBean sessionbean,String menuId)
	{
		this.sessionbean=sessionbean;
		this.setCaption("DAILY LATE IN EMPLOYEE LIST :: "+sessionbean.getCompany());
		this.setWidth("475px");
	...
	private void reportShow()
	{
		...
		{ 
			...
			String query = "select * from funDailyEmployeeAttendance('"+cmbDate.getValue()+"','"+cmbUnit.getValue()+"',"
					...
					" where iLateCount>0 order by  vDepartmentName,iRank,dJoiningDate";
			...
			if(!lst.isEmpty())
			{
				...
				Window win = new ReportViewer(hm,"report/account/hrmModule/rptDailyLateAttendence.jasper",
						this.getWindow().getApplication().getContext().getBaseDirectory()+"".replace("\\","/")+"/VAADIN/rpttmp",
						this.getWindow().getApplication().getURL()+"VAADIN/rpttmp",false,
						this.getWindow().getApplication().getURL()+"VAADIN/applet",true);

				win.setCaption("Daily Late In Report");
