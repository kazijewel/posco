...
public class RptMonthlyMobileAllowanceSheet extends Window {
	...
	public RptMonthlyMobileAllowanceSheet(SessionBean sessionBean,String menuId)
	{
		this.sessionBean=sessionBean;
		this.setCaption("MONTHLY MOBILE ALLOWANCE SHEET :: "+sessionBean.getCompany());
	...
	private void reportShow()
	{
		...
		try
		{
			...
			rptName="rptMonthlyMobileAllowanceSheet.jasper";
