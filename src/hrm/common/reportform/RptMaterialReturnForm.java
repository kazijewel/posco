...
public class RptMaterialReturnForm extends Window
{
	...
	public RptMaterialReturnForm(SessionBean sessionBean,String menuId)
	{
		this.sessionBean=sessionBean;
		this.setCaption("MATERIAL RETURN FORM(NOC) :: "+sessionBean.getCompany());
	...
	private void reportView()
	{
		...
		try
		{
			...
			rptName="RptMaterialReturnForm.jasper";
