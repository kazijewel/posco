...
public class RptEmployeeJoiningLetter extends Window
{
	...
	public RptEmployeeJoiningLetter(SessionBean sessionBean,String menuId)
	{
		this.sessionBean=sessionBean;
		this.setCaption("EMPLOYEE JOINING LETTER :: "+sessionBean.getCompany());
	...
	private void reportView()
	{
		...
		try
		{
			query = "select vEmployeeName,convert(varchar, dJoiningDate, 106)dJoiningDate,vDesignationName,vContactNo "
					+ "from tbEmpOfficialPersonalInfo where vEmployeeId like '"+empId+"'";

			rptName="RptEmployeeJoiningLetter.jasper";
