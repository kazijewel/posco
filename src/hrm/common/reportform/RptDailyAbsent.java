...
public class RptDailyAbsent extends Window 
{
	...
	public RptDailyAbsent(SessionBean sessionBean) 
	{
		this.sessionBean=sessionBean;
		this.setCaption("DAILY ABSENT :: "+sessionBean.getCompany());
			...
			if(queryValueCheck(query))
			{
				...
				if(!queryValueCheck(query))
				{
					...
					if(queryValueCheck(query))
					{
						...
						Window win = new ReportViewer(hm,"report/account/hrmModule/rptDailyAbsentRegister.jasper",
