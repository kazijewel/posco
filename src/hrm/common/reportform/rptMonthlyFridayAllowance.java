...
public class rptMonthlyFridayAllowance extends Window
{
	...
	public rptMonthlyFridayAllowance(SessionBean sessionBean,String menuId)
	{
		this.sessionBean=sessionBean;
		this.setCaption("MONTHLY HOLIDAY ALLOWANCE :: "+sessionBean.getCompany());
	...
	private void reportShow()
	{
		...
		{			
			...
			String query="select * from funMonthlyFridayAllowance ('"+dSalaryMonth.getValue()+"',"
			...
			if(queryValueCheck(query))
			{
				...
				hm.put("MonthName", monthFormat.format(dSalaryMonth.getValue()));
				hm.put("Year", yearFormat.format(dSalaryMonth.getValue()));
