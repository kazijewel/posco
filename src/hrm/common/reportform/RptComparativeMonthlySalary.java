...
public class RptComparativeMonthlySalary extends Window {
	...
	public RptComparativeMonthlySalary(SessionBean sessionBean)
	{
	...
	private void reportShow()
	{
		...
		try
		{
			...
			query = "select * from funCumulativeMonthlySalary('"+dFormat.format(dSalaryMonth.getValue())+"','"+section+"') where totalNetIncomeThis >0.00 or totalNetIncomePrev >0.00 order by sectionID";
