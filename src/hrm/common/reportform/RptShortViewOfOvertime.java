...
public class RptShortViewOfOvertime extends Window{
	...
	public RptShortViewOfOvertime(SessionBean sessionBean,String menuId) 
	{
		this.sessionBean=sessionBean;
		this.setCaption("SHORT VIEW OF OVERTIME :: "+sessionBean.getCompany());
	...
	private void reportShow()
	{
		...
		if(dfMonth.format(cmbDate.getValue()).equalsIgnoreCase("02"))
		{
			...
			if(year%4 == 0)
		    {
		        if( year%100 == 0)
		        {
		            if ( year%400 == 0)
		            {
				    	report="report/account/hrmModule/RptShortViewOfOvertime29.jasper";
					}
		            else
		            {
				    	report="report/account/hrmModule/RptShortViewOfOvertime28.jasper";
					}
		        }
		        else
		        {
		...
		{
			report="report/account/hrmModule/RptShortViewOfOvertime31.jasper";
		}
		...
		{
			report="report/account/hrmModule/RptShortViewOfOvertime30.jasper";
		}
		
		ReportOption RadioBtn= new ReportOption(RadioBtnGroup.getValue().toString());
		try
		{			
			String query = "select * from RptShortViewOfOvertime('"+cmbDate.getValue()+"','"+cmbUnit.getValue().toString()+"','"+dept+"','"+secId+"','"+empId+"') " +
