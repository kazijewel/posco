...
public class RptMonthlyAttendanceSummary extends Window{
	...
	public RptMonthlyAttendanceSummary(SessionBean sessionBean,String menuId) 
	{
		this.sessionBean=sessionBean;
		this.setCaption("EMPLOYEE WISE MONTHLY REPORT :: "+sessionBean.getCompany());
	...
	public void addUnitData()
	{
		...
		try
		{
			String query="select distinct vUnitId,vUnitName from tbEmployeeAttendanceFinal where MONTH(dDate)=MONTH('"+cmbDate.getValue()+"') order by vUnitName ";
	...
	public void addEmployeeName()
	{
		...
		try
		{
			String query = "select distinct vEmployeeID,vEmployeeCode,vEmployeeName from tbEmployeeAttendanceFinal " +
					...
					"and vDepartmentId like '"+dept+"' and vSectionId like '"+secId+"' and vEmployeeID like '"+empId+"' order by vEmployeeCode";
	...
	private void reportShow()
	{
		...
		try
		{			
			String query = "select * from funMonthlyEmployeeAttendance(" +
					"'"+cmbDate.getValue()+"'," +
					"'"+cmbUnit.getValue().toString()+"'," +
					"'"+dept+"'," +
					"'"+secId+"'," +
					"'"+empId+"') order by iRank";
