...
public class PFLoanAppFind extends Window 
{
	...
	public PFLoanAppFind(SessionBean sessionBean, TextRead txtAuto, TextRead txtFindDate)
	{		
		this.txtAutoId = txtAuto;
		this.txtFindDate = txtFindDate;
		this.sessionBean = sessionBean;
		this.setCaption("FIND PF LOAN INFORMATION :: "+sessionBean.getCompany());
		this.center();
		this.setWidth("570px");
	...
	private void UnitDataAdd()
	{
		...
		try
		{
			String query = "select epo.vUnitId,epo.vUnitName from tbPFLoanApplication la inner join tbEmpOfficialPersonalInfo epo on epo.vEmployeeId=la.vAutoEmployeeId order by epo.vUnitName ";
	...
	private void sectionDataAdd()
	{
		...
		try
		{
			String query = "select distinct epo.vSectionId,epo.vSectionName from tbPFLoanApplication la inner join tbEmpOfficialPersonalInfo epo on epo.vEmployeeId=la.vAutoEmployeeId where "
	...
	private void DepartmentDataAdd()
	{
		...
		try
		{
			String query = "select distinct epo.vDepartmentId,epo.vDepartmentName from tbPFLoanApplication la inner join tbEmpOfficialPersonalInfo epo on epo.vEmployeeId=la.vAutoEmployeeId where "
	...
	private void findButtonEvent()
	{
		...
		try
		{
			String Findquery = " select vLoanNo,la.dApplicationDate,epo.vEmployeeName,epo.vDesignationName from tbPFLoanApplication la inner join tbEmpOfficialPersonalInfo epo on epo.vEmployeeId=la.vAutoEmployeeId " +
	...
	private void addEmployeeData()
	{
		...
		try
		{
			String query = "select epo.vEmployeeId,epo.vEmployeeName,epo.vEmployeeCode from tbPFLoanApplication la inner join tbEmpOfficialPersonalInfo epo on epo.vEmployeeId=la.vAutoEmployeeId where "
