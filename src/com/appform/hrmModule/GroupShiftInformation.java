...
public class GroupShiftInformation extends Window 
{
	...
	public GroupShiftInformation(SessionBean sessionBean)
	{
		this.sessionBean = sessionBean;
		this.setResizable(false);
		this.setCaption("GROUP SHIFT INFORMATION :: "+sessionBean.getCompany());
