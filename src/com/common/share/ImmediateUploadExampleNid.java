...
public class ImmediateUploadExampleNid extends VerticalLayout
{
	...
	public ImmediateUploadExampleNid(String fname)
	{
		coreName = fname;
		fileName = fname;
		setSpacing(true);
	...
	public void initialCmp()
	{
		...
		upload.setWidth("85px");
		upload.setHeight("20px");
		upload.setButtonCaption("Attach NID");
