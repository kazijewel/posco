...
public class ReportViewerNew extends Window{
	public String pdfLocationGenerate = "";
	public String pdfNameGenerate = "";
	public ReportViewerNew(HashMap para,String jasper,String pdfOutPath,String url,Boolean isHqlSql) throws JRException, IOException{
			ReportPdf(para,jasper,pdfOutPath,url,isHqlSql); 
	}
	public ReportViewerNew(HashMap para,String jasper,String pdfOutPath,String url,Boolean isHqlSql,String appletCodebase,int isPdf) throws JRException, IOException{
		if(isPdf == 1)
			ReportPdf(para,jasper,pdfOutPath,url,isHqlSql); 
		else
