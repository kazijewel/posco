...
public class ImmediateUploadExampleBirth extends VerticalLayout
{
	...
	public ImmediateUploadExampleBirth(String fname)
	{
		coreName = fname;
		fileName = fname;
		setSpacing(true);
	...
	public void initialCmp()
	{
		...
		upload.setImmediate(true);
		upload.setWidth("110px");
		upload.setHeight("20px");
		upload.setButtonCaption("Birth Certificate");
