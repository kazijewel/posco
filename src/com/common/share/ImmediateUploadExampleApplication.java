...
public class ImmediateUploadExampleApplication extends VerticalLayout
{
	...
	public ImmediateUploadExampleApplication(String fname)
	{
		coreName = fname;
		fileName = fname;
		setSpacing(true);
	...
	public void initialCmp()
	{
		...
		upload.setWidth("90px");
		upload.setHeight("20px");
		upload.setButtonCaption("Application");
