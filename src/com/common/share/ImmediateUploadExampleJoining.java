...
public class ImmediateUploadExampleJoining extends VerticalLayout
{
	...
	public ImmediateUploadExampleJoining(String fname)
	{
		coreName = fname;
		fileName = fname;
		setSpacing(true);
	...
	public void initialCmp()
	{
		...
		upload.setButtonCaption("Joining Letter");
